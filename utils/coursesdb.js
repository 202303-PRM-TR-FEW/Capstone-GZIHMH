...
const initialCourses = [
  ...
  //python
  {
    ...
    description:
      "In this series we will be walking through everything you need to know to get started in Python!",
  ...
  //react//
  {
    ...
    description:
      "This React JS Full Course for Beginners is an all-in-one beginner tutorial and complete course full of nearly 9 hours of React JS code and instruction to level up your programming skills",
    totalDuration: "01:40:33",
    rate: 4.5,
    tutorId: "",
    price: 45,
  ...
  //Nina Drawing//
  {
    ...
    description:
      "My name is Nina Blangstrup and art is one of my great passions! This course is filled with art, drawings, portraits and tutorials",
    totalDuration: "03:33:01",
    rate: 3.5,
    tutorId: "",
    thumbnail: "",
  ...
  //rafy Marketer//
  {
    ...
    description:
      "Email Marketing is one of the most effective marketing process most of the businesses, bloggers, content creators and influencers using and MailChimp is one of the best easy Email Marketing Platform peoples are using for the email marketing campaigns.",
    totalDuration: "03:33:01",
    rate: 4.9,
    tutorId: "",
    thumbnail: "",
...
const initialLessons = [
  ...
  },
  {
    ...
    linkSectionNumber: 2,
    linkSectionName:
      "Shading Tutorial - Everything You Need to Know about Shading Technique",
    linkSubsectionNumber: 1,
  },
  {
    courseId: "",
  ...
  },
  {
    ...
    linkTitle:
      "Full FREE Email Marketing Tutorial - What we Need to & Will Learn? - Lesson 1",
    linkSectionNumber: 2,
  ...
  },
  {
    ...
    linkTitle:
      "What is Email Marketing - Can Spam Law & How Does it Works? - Lesson 2",
    linkSectionNumber: 2,
