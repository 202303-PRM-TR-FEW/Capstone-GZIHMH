const categories_db = [{
        id: 1,
        name: 'Sales',
        svg: `(<svg viewBox="0 0 512 512" style={{ width: '32px', height: '32px', overflow: 'visible', opacity: '1', zIndex: '1', fill: 'rgb(177, 177, 177)' }}>
...
`
    ...
    },
    {
        id: 2,
        name: 'HR',
        svg: `(<svg style={{ width: '28px', height: '28px', overflow: 'visible', opacity: '1', zIndex: '1', fill: 'rgb(177, 177, 177)' }} viewBox="0 0 640 512">
    ...
    },
    {
        id: 3,
        name: 'Drawing',
        svg: `(<svg viewBox="0 0 24 24" style={{ width: '32px', height: '32px', overflow: 'visible', opacity: '1', zIndex: '1', fill: 'rgb(177, 177, 177)' }}>
    ...
    },
    {
        id: 4,
        name: 'Big Data',
        svg: `(<svg style={{ width: '26px', height: '26px', overflow: 'visible', opacity: '1', zIndex: '1', fill: 'rgb(177, 177, 177)' }} viewBox="0 0 512 512">
    ...
    },
    {
        id: 5,
        name: 'Design',
        svg: `(<svg style={{ width: '28px', height: '28px', overflow: 'visible', opacity: '1', zIndex: '1', fill: 'rgb(177, 177, 177)' }} viewBox="0 0 24 24">
