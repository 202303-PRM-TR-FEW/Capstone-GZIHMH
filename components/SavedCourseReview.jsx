  ...
  return (
    <section className='bg-white flex flex-col rounded-2xl'>
      ...
      <div>
        ...
        <div className='flex flex-col lg:flex-row md:flex-col sm:flex-col items-center justify-evenly mt-5  lg:mt-5 md:mt-2 sm:mt-1'>
          <button className="text-primary m-3 text-1xl font-bold bg-transparent border border-primary w-80 h-9 rounded-2xl hover:text-white hover:bg-primary">REVIEW </button>
