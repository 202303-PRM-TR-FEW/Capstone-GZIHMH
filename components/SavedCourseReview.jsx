    ...
    <section className="flex flex-col items-center bg-white ">
      <div className="flex flex-col items-center mt-20">
        ...
        <div className="flex flex-col justify-start ml-4 ">
          <h2 className="p-3 mt-4 mb-4">{course.title}</h2>
      ...
      <div>
        <div className="flex mt-20 justify-evenly">
          <button className="p-2 m-3 font-bold bg-transparent border text-primary text-1xl border-primary w-80 h-11 rounded-2xl hover:text-white hover:bg-blue-400">
            REVIEW{" "}
          </button>
          <button className="p-2 m-3 font-bold bg-transparent border text-primary text-1xl border-primary w-80 h-11 rounded-2xl hover:text-white hover:bg-blue-400">
            BUY NOW
