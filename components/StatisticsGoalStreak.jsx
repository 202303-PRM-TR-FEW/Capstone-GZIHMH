...
const StatisticsGoalStreak = () => {
  return (
    ...
    <div className='flex items-center justify-center '>
      ...
      <div className='rounded-2xl bg-white    h-30 m-2 flex flex-col'>
        ...
        <div className='bg-blue-50 p-5 px-28  mb-3   mx-4  rounded-2xl '>
      ...
      <div className='rounded-2xl bg-white w-auto h-30 m-2 flex flex-col'>
        ...
        <div className='bg-lime-50  p-5 px-28  mb-3   mx-4  rounded-2xl '>
            <p className='text-lime-500 font-bold '> 103 days</p>
          </div>
      </div>
