...
const HomeCategories = () => {
    return (
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-7 gap-2 p-2.5">
            <div className="flex flex-col items-center rounded-2xl shadow category-icon--container hover:bg-[#CBE1FA] hover:border-blue-500 border hover:text-[#2E8DFF] text-[#616161] bg-[#fbfbfb] p-2">
                <div>
                ...
                <p className="mt-2 text-sm font-bold">Sales</p>
            </div>
            <div className="flex flex-col items-center rounded-2xl shadow category-icon--container hover:bg-[#CBE1FA] hover:border-blue-500 border hover:text-[#2E8DFF] text-[#616161] bg-[#fbfbfb] p-2">
                <div>
                ...
                <p className="mt-2 text-sm font-bold">HR</p>
            </div>
            <div className="flex flex-col items-center rounded-2xl shadow category-icon--container hover:bg-[#CBE1FA] hover:border-blue-500 border hover:text-[#2E8DFF] text-[#616161] bg-[#fbfbfb] p-2">
                <div>
                ...
                <p className="mt-2 text-sm font-bold">Drawing</p>
            </div>
            <div className="flex flex-col items-center rounded-2xl shadow category-icon--container hover:bg-[#CBE1FA] hover:border-blue-500 border hover:text-[#2E8DFF] text-[#616161] bg-[#fbfbfb] p-2">
                <div>
                ...
                <p className="mt-2 text-sm font-bold">Big Data</p>
            </div>
            <div className="flex flex-col items-center rounded-2xl shadow category-icon--container hover:bg-[#CBE1FA] hover:border-blue-500 border hover:text-[#2E8DFF] text-[#616161] bg-[#fbfbfb] p-2">
                <div>
                ...
                <p className="mt-2 text-sm font-bold">Design</p>
            </div>
            <div className="flex flex-col items-center rounded-2xl shadow category-icon--container hover:bg-[#CBE1FA] hover:border-blue-500 border hover:text-[#2E8DFF] text-[#616161] bg-[#fbfbfb] p-2">
                <div>
                ...
                <p className="mt-2 text-sm font-bold">Marketing</p>
            </div>
            <div className="flex flex-col items-center rounded-2xl shadow category-icon--container hover:bg-[#CBE1FA] hover:border-blue-500 border hover:text-[#2E8DFF] text-[#616161] bg-[#fbfbfb] p-2">
                <div>
                ...
                <p className="mt-2 text-sm font-bold">Astronomy</p>
            </div>
        </div>
    );
};
