...
function SavedCourses() {
  ...
  return (
    <div className="flex flex-col h-full lg:flex-row md:flex-col sm:flex-col">
      <div className="">
        <h1 className="pl-4 py-1.5">Saved Courses</h1>
        <div className="flex-1 max-h-[644px] overflow-y-auto">
          {savedCourses.map((course, index) => (
            <div
              className="flex rounded-2xl w-[570px] h-[148px] m-3 opacity-100 bg-white hover:bg-blue-200 bg-opacity-30 rounded-5 border hover:border-primary"
              key={course.id}
            >
                ...
                <div className="flex flex-row justify-between mt-2 ">
                  ...
                  <span>
                    <svg
                      ...
                      strokeWidth={1.5}
                      stroke="currentColor"
                      className="self-start w-5 h-5 m-2 fill-current text-primary"
                    >
                      <path
                        strokeLinecap="round"
