...
const Achievements = () => {
  return (
    ...
    <div className='flex flex-col items-start justify-center h-screen m-3'>
           ...
           <div><h2 className=' text-xl ' > Achievements </h2></div>


    <div className='bg-gray-300  m-2  w-auto h-30 rounded-lg flex flex-row '>

                <div className='bg-orange-200 w-20 h-20 rounded-lg m-2 flex items-center justify-center'>
        ...
        <dev className='flex flex-col items-start '  >
            ...
            <dev className='flex flex-row items-center justify-between '> 
                ...
                <div className=' m-1 text-gray-500 font-bold ml-2  mr-10 '> Commited Learner </div>
...
<div className='bg-lime-200 w-20 h-20 rounded-lg m-2 flex items-center justify-center'>
  ...
  <path d="M6 4v2a6 6 0 1 0 12 0v-2a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1z" />
        ...
        <dev className='flex flex-col items-start '  >
            ...
            <dev className='flex flex-row items-center justify-between '> 
                ...
                <div className=' m-1 text-gray-500 font-bold ml-2 m mr-20 '> Point Collector </div>

                <div>
                <p className='text-gray-500 text-sm m-4 ml-12 '> 1200/3000 </p>
                </div>
