...
<div className='flex flex-row mt-10'>
      <div className='rounded-2xl p-2 flex flex-col w-1/2'>
        ...
        {randomCourses.map((course) => (
          <div className='flex h-275 m-1 w-[650px] h-[185px] rounded-2xl opacity-100 bg-white hover:bg-blue-200 bg-opacity-30 border hover:border-primary' key={course.id} onClick={() => handleCourseClick(course.id)}>
